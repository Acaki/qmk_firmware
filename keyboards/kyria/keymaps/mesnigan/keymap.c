...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_wrapper(
        ...
        _______, ___________________BLANK___________________, _______, _______,    _______, _______, _________________MOUSE_R3__________________, _______,
    ...
    [_LOWER] = LAYOUT_wrapper(
        ...
        KC_F11,  _________________LOWER_L3__________________, _______, _______,     KC_HOME, _______, _________________LOWER_R3__________________, KC_F12,
