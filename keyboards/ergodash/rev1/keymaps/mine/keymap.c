...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_4key_2u_inner(
            ...
            KC_CAPS, KC_Z, KC_X, KC_C, KC_V, KC_B, MO(1), MO(1), KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, MO(1),
            KC_LCTL, KC_LGUI, KC_APP, KC_LALT, KC_LSFT, KC_SPC, KC_LCTL, KC_RCTL, KC_BSPC, KC_RSFT, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
	        ),
