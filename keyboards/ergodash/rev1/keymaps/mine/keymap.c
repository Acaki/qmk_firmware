...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_4key(
            ...
            KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_QUOT, KC_BSLS, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT,
            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LCTL, KC_RCTL, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TG(2),
            KC_LCTL, KC_APP, KC_LGUI, KC_LALT, KC_SPC, KC_LSFT, MO(1), MO(1), KC_RSFT, KC_BSPC, KC_RALT, KC_RGUI, KC_APP, KC_MPLY
	        ),
    [1] = LAYOUT_4key(
