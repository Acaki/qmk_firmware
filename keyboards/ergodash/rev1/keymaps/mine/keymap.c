...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_4key(
            KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_LEFT_PAREN, KC_RIGHT_PAREN, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSLS,
            ...
            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LCTL, KC_RCTL, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_DEL,
            KC_LCTL, KC_APP, KC_LGUI, KC_LALT, KC_SPC, KC_LSFT, MO(1), MO(1), KC_RSFT, KC_BSPC, KC_RALT, C(KC_C), C(KC_V), KC_MPLY
	        ),
    [1] = LAYOUT_4key(
            _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F11, KC_F12, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, RESET,
            _______, KC_BTN4, KC_BTN1, KC_MS_UP, KC_BTN2, KC_MS_WH_UP, _______, _______, _______, KC_PGUP, KC_UP, KC_PGDN, KC_HOME, _______,
