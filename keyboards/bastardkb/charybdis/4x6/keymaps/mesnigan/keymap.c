...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCL] = LAYOUT_charybdis_base_wrapper(
      _________________FUNCL_R1__________________, ___________________BLANK___________________,
      _________________FUNCL_R2__________________, ___________________BLANK___________________,
      _________________FUNCL_R3__________________, ___________________BLANK___________________,
      _________________COMMON_LT_________________, _________________COMMON_RT_________________
    ),
