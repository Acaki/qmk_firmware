...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCL] = LAYOUT_charybdis_base_wrapper(
      _________________FUNCL_L1__________________, ___________________BLANK___________________,
      _________________FUNCL_L2__________________, ___________________BLANK___________________,
      _________________FUNCL_L3__________________, ___________________BLANK___________________,
      _________________COMMON_LT_________________, _________________COMMON_RT_________________
    ),
    ...
    [_NUMBL] = LAYOUT_charybdis_base_wrapper(
      ...
      ___________________BLANK___________________, _________________NUMBL_R2__________________,
      ___________________BLANK___________________, _________________NUMBL_R3__________________,
      _________________COMMON_LT_________________, _________________NUMBL_RT__________________
    ),
