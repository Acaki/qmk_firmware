  ...
  LAYOUT_split_4x6_5_wrapper( \
      ...
      KC_GRV,  K21,    K22,    K23,    K24,    K25,                                                      K26,     K27,     K28,     K29,     K2A,     KC_BSLS, \
                                       K31,    K32,    K33,                                              K34,     K36,     K35,     \
                                          DRAG_SCROLL, GAMING_S,                                         _______, DRAG_SCROLL  \
  )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_split_4x6_5_wrapper(
        GAMING, ___________________BLANK___________________,                                    ___________________BLANK___________________, _______,
        ...
        KC_GRV, _______, _______, _______, _______, _______,                                    _______, _______, _______, _______, _______, _______,
                                  KC_LCTL, KC_SPC,  LT(_LOWER, KC_ESC),                         KC_BSPC, _______, _______,
                                           KC_LALT, KC_LGUI,                                    _______, KC_DEL
    ),
    ...
    [_GAMING_S] = LAYOUT_split_4x6_5_wrapper(
        ...
        _______,  _________________GAMING_L2S________________,                                      ___________________BLANK___________________, _______,
        _______,  _________________GAMING_L3S________________,                                      ___________________BLANK___________________, _______,
    ...
    [_MOUSE] = LAYOUT_split_4x6_5_wrapper(
        _______, ___________________BLANK___________________,                                       ___________________BLANK___________________, _______,
        _______, ___________________BLANK___________________,                                       ___________________BLANK___________________, _______,
        _______, C(KC_A), KC_BTN3, KC_BTN2, KC_BTN1, _______,                                       _______, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______,                                       ___________________BLANK___________________, _______,
