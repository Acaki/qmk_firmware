...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_split_4x6_5_wrapper(
        GAMING,  ___________________BLANK___________________,                                    ___________________BLANK___________________, KC_MINS,
        ...
        _______, ___________________BLANK___________________,                                    ___________________BLANK___________________, _______,
                                  KC_LCTL, KC_SPC,  LT(_LOWER, KC_ESC),                          KC_BSPC, _______, _______,
                                           KC_LALT, KC_LALT,                                     _______, KC_DEL
    ),

    [_GAMING_S] = LAYOUT_split_4x6_5_wrapper(
        GAMING_S, ___________________BLANK___________________,                                      ___________________BLANK___________________, _______,
