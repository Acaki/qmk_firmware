...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBL] = LAYOUT_charybdis_base_wrapper(
      _________________SYMBL_L1__________________, ___________________BLANK___________________,
      _________________SYMBL_L2__________________, ___________________BLANK___________________,
      _________________SYMBL_L3__________________, ___________________BLANK___________________,
      _________________COMMON_LT_________________, _________________COMMON_RT_________________
    ),
