...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_split_4x6_5_wrapper(
        ...
        _______, _________________GAMING_L3_________________,                                       ___________________BLANK___________________, _______,
                                   KC_LCTL, _______, LT(_LOWER, KC_ESC),                            _______, _______, _______,
    ...
    [_GAMING_GC] = LAYOUT_split_4x6_5_wrapper(
        _______, ___________________BLANK___________________,                                       ___________________BLANK___________________, _______,
        _______, ___________________BLANK___________________,                                       ___________________BLANK___________________, _______,
        _______, _______, FARM,    _______, _______, _______,                                       ___________________BLANK___________________, _______,
        _______, ___________________BLANK___________________,                                       ___________________BLANK___________________, _______,
