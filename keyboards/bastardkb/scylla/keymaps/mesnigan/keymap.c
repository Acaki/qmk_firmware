...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_split_4x6_5_wrapper(
        ...
        _______, _________________GAMING_L1_________________,                                       ___________________BLANK___________________, _______,
    ...
    [_GAMING_GC] = LAYOUT_split_4x6_5_wrapper(
        _______, ___________________BLANK___________________,                                       ___________________BLANK___________________, _______,
        _______, _________________GAMING_L1_________________,                                       ___________________BLANK___________________, CCLICK,
        KC_LSFT, KC_G,    FIRE,    FARM,    KC_D,    KC_F,                                          _________________GAMING_R2_________________, _______,
        _______, _________________GAMING_L3_________________,                                       ___________________BLANK___________________, _______,
                                   KC_LCTL, KC_SPC,  LT(_LOWER, KC_ESC),                            KC_BSPC, _______, _______,
                                            KC_LALT, _______,                                       _______, _______
    ),
    ...
    [_NUMBL] = LAYOUT_scylla_base_wrapper(
        ...
        _________________NUMBL_LT__________________, _________________QWERTY_RT_________________
    ),
