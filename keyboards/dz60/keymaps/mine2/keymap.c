...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_calbatr0ss(
            ...
            KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO, KC_NO,
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, ARROW, DBLARROW, KC_NO, KC_MUTE, KC_MPRV, KC_MNXT,
            KC_NO, KC_NO, KC_NO, TG(1), KC_TRNS, KC_ENT, KC_MPLY, KC_TRNS, KC_VOLD, KC_VOLU
            ),
};
