...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_60_b_mine(
	        ...
	        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LOCK,
	        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RCTL, MO(1), KC_RALT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
	        ),
    [1] = LAYOUT_60_b_mine(
	        _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, RESET,
	        KC_HOME, KC_PGUP, KC_UP, KC_PGDN, _______, DBLARROW, _______, _______, KC_VOLU, _______, _______, _______, _______, _______,
	        KC_END, KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSPC, ARROW, _______, KC_MPRV, KC_VOLD, KC_MNXT, KC_MPLY, _______, _______,
	        _______, _______, KC_CALC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	        _______, _______, _______, KC_ENT, TG(2), _______, MO(3), _______, _______, _______, _______
	        ),
    [2] = LAYOUT_60_b_mine(
