...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_b_ansi(
	        ...
	        _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, _______, _______, _______, _______,
	        _______, _______, _______, KC_CALC, KC_APPLICATION, _______, _______, _______, _______, _______, _______, KC_VOLU, _______,
	        _______, _______, _______, TG(2), _______, _______, MO(3), _______, KC_MPRV, KC_VOLD, KC_MNXT
	        ),
    [2] = LAYOUT_60_b_ansi(
