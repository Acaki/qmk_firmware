...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_b_ansi(
	        ...
	        _______, _______, _______, _______, _______, _______, DBLARROW, KC_HOME, KC_UP, KC_END, KC_PGUP, _______, _______, _______,
	        _______, _______, _______, _______, _______, _______, ARROW, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, _______, _______,
	        _______, _______, KC_CALC, _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLU, _______,
	        _______, _______, _______, _______, _______, TG(2), MO(3), _______, KC_MPRV, KC_VOLD, KC_MNXT
	        ),
    [2] = LAYOUT_60_b_ansi(
