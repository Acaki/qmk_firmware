...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_b_ansi(
	        ...
	        KC_PGUP, KC_HOME, KC_UP, KC_END, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ ,
	        KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSPC, _______, _______, _______, _______, _______, _______, _______, _______,
	        _______, _______, _______, KC_CALC, KC_APPLICATION, _______, _______, _______, _______, _______, _______, KC_VOLU, _______,
	        _______, _______, _______, KC_ENT, TG(2), _______, MO(3), _______, KC_MPRV, KC_VOLD, KC_MNXT
	        ),
    [2] = LAYOUT_60_b_ansi(
