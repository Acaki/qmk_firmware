...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_60_b_ansi(
	        ...
	        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RCTL, LT(1, KC_ENT), KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT
	        ),
    [1] = LAYOUT_60_b_ansi(
	        KC_GRAVE, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, RESET,
	        _______, KC_PGUP, KC_HOME, KC_UP, KC_END, ARROW, _______, _______, _______, _______, _______, _______, _______, _______ ,
	        _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, DBLARROW, _______, _______, _______, _______, _______, _______, _______,
	        _______, _______, _______, KC_CALC, KC_APPLICATION, _______, _______, _______, _______, _______, _______, KC_VOLU, _______,
	        _______, _______, _______, KC_BSPC, TG(2), _______, MO(3), _______, KC_MPRV, KC_VOLD, KC_MNXT
	        ),
    [2] = LAYOUT_60_b_ansi(
