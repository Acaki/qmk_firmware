...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_60_b_ansi(
	        ...
	        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RCTL, LT(1, KC_BSPC), KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT
	        ),
    [1] = LAYOUT_60_b_ansi(
	        ...
	        _______, _______, _______, _______, TG(2), _______, MO(3), _______, KC_MPRV, KC_VOLD, KC_MNXT
	        ),
    [2] = LAYOUT_60_b_ansi(
